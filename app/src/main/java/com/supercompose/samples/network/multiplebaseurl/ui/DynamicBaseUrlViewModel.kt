package com.supercompose.samples.network.multiplebaseurl.ui

import android.util.Log
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.supercompose.samples.network.multiplebaseurl.data.ApiType
import com.supercompose.samples.network.multiplebaseurl.data.DeploymentType
import com.supercompose.samples.network.multiplebaseurl.data.EnvironmentManager
import com.supercompose.samples.network.multiplebaseurl.data.EnvironmentModel
import com.supercompose.samples.network.multiplebaseurl.data.services.AuthService
import com.supercompose.samples.network.multiplebaseurl.data.services.ContentService
import com.supercompose.samples.network.multiplebaseurl.data.services.PaymentService
